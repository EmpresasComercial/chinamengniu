...
export default function RechargeHelp() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#e8ebf5] antialiased">
      {/* Header */}
      ...
      <main className="flex-grow p-4">
        ...
        <section className="bg-white rounded-[2rem] p-6 shadow-sm min-h-[500px]">
          {/* Title Section */}
          <h1 className="text-2xl font-bold mb-4 text-[#001a4d]">como recarregar sua conta</h1>
          ...
          <div className="space-y-4 text-justify">
            <p className="text-[0.925rem] leading-[1.6] text-[#333]">
