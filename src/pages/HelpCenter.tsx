      ...
      <main className="flex-grow p-4">
        ...
        <section className="bg-white rounded-3xl shadow-sm overflow-hidden">
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-6 py-6 border-b border-gray-100 hover:bg-gray-50 transition-colors text-left"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-6 py-6 hover:bg-gray-50 transition-colors text-left"
          >
